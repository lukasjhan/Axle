...
| OpenID4VP hardening: DCQL `require_cryptographic_holder_binding` | ⬜ the trust-free remainder of the OpenID4VP gap; `trusted_authorities` is sequenced with the trust cluster below |
